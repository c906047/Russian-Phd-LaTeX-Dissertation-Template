...
Ссылки \nom[]{Ссылки}{Это ссылки конечно же.} на собственные работы:~\cite{vakbib1, confbib1}
...
Вот так может выглядеть формула \nom[]{Формула}{Формула такая формула, ололо}, которую необходимо вставить в строку по тексту: $x \approx \sin x$ при $x \to 0$.
